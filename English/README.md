...
| 调整堆大小          | Adjust Heap Size                    |             |                               |
| 调整垃圾回收器参数  | Tuning Garbage Collector Parameters |             |                               |
| 减少对象创建        | Reduce Object Creation              |             |                               |
| 优化内存分配        | Optimize Memory Allocation          |             |                               |
| 增加元空间大小      | Increase Metaspace Size             |             |                               |
| 命令行              | command-line                        |             |                               |
...
| 自动故障恢复        | Automatic Recovery                  |             | /ˌɔːtəˈmætɪk rɪˈkʌvəri/       |

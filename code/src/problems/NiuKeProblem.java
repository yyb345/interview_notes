...
//         int[][] vw = new int[][]{{1,3},{9,8}};
//         int V=10;
//         int n = 2;
//
//        int[][]grid = new int[][]{{1,3,1,4},{1,5,1,4},{4,2,1,4}};
//
...
//        System.out.println(new NiuKeProblem().treeToDoublyList(treeNode));



        //int[] xx = new int[]{6,18,27,40,46,57,59,66,72,91};// 65
        //int [] xx= new int[]{16,16,18,24,30,32};//
        int[] xx = new int[]{6,18,27,40,46,57,59,66,72,91}; //65
        twoSum(xx,65);
    }

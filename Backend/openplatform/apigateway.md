...
1. 生产关系（4个角色 ISV/ISP/ 平台/商家 +商业模式决定的）
...
硬件负载（F5）、软负载（LVS/Ngnix）LVS是4层（传输层） Ngnix是7层（http协议层，用户空间）
...
数据库相关（事物/索引/锁/性能优化/主从）

业务上：数据库模型简化，之前的7个表==> 2个表

技术问题：测试用例：深分页问题/删除数据锁表/ 
